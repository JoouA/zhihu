                    ...
                    <div class="panel-body">
                        <form action="/questions/{{ $question->id }}" method="post">
                            ...
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="标题"  id="title" value="{{ $question->title or old('title') }}">
                                @if ($errors->has('title'))
                            ...
                            <button type="submit"  class="btn btn-success pull-right">编辑问题</button>
                        </form>
                    </div>
                </div>
            </div>
